...
RATE is implemented as a set of parallelizable routines, which can be carried out within an R environment. [Supplementary Material](http://lcrawlab.com/Papers/RATE_SI.pdf) for Crawford et al. (2018) can also be found on our lab website.
